...
#ifndef FTY_METRIC_COMPOSITE_CONFIGURATOR_SERVER_H_INCLUDED
#define FTY_METRIC_COMPOSITE_CONFIGURATOR_SERVER_H_INCLUDED
...
//  Composite metrics configurator actor
